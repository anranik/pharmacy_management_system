<header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav custom_btn_link">
                <li><a href="#"><button class="btn btn-ttp"><span class="glyphicon glyphicon-plus"></span> Invoice</button></a></li>
                <li><a href="#"><button class="btn btn-ttp"><span class="glyphicon glyphicon-plus"></span> Payment</button></a></li>
                <li><a href="#"><button class="btn btn-ttp"><span class="glyphicon glyphicon-plus"></span> Receipt</button></a></li>
            </ul>
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">{{ trans_choice('strings.backend.general.you_have.messages', 10, ['number' => 5]) }}</li>
                        <li class="footer">
