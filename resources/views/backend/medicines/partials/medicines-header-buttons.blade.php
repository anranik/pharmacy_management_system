<!--Action Button-->
@if( Active::checkUriPattern( 'admin/medicines' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.medicines.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.medicines.all' ) }}
            </a>
        </li>
        @permission( 'create-medicine' )
            <li>
                <a href="{{ route( 'admin.medicines.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.medicines.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
