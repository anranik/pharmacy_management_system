<!--Action Button-->
@if( Active::checkUriPattern( 'admin/manufacturers' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.manufacturers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.manufacturers.all' ) }}
            </a>
        </li>
        @permission( 'create-manufacturer' )
            <li>
                <a href="{{ route( 'admin.manufacturers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.manufacturers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
