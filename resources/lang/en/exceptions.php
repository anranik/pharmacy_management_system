...
return [
	...
	"medicinecategories" => [
	"already_exists" => "That Medicinecategory already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Medicinecategory. Please try again.",
	"delete_error" => "There was a problem deleting this Medicinecategory. Please try again.",
	"not_found" => "That Medicinecategory does not exist.",
	"update_error" => "There was a problem updating this Medicinecategory. Please try again.",
	],
	"manufacturers" => [
	"already_exists" => "That Manufacturer already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Manufacturer. Please try again.",
	"delete_error" => "There was a problem deleting this Manufacturer. Please try again.",
	"not_found" => "That Manufacturer does not exist.",
	"update_error" => "There was a problem updating this Manufacturer. Please try again.",
	],
	"medicines" => [
	"already_exists" => "That Medicine already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this Medicine. Please try again.",
	"delete_error" => "There was a problem deleting this Medicine. Please try again.",
	"not_found" => "That Medicine does not exist.",
	"update_error" => "There was a problem updating this Medicine. Please try again.",
	],
	"sales" => [
	"already_exists" => "That Sale already exists. Please choose a different name.",
	...
	"not_found" => "That Sale does not exist.",
	"update_error" => "There was a problem updating this Sale. Please try again.",
	],
	"customers" => [
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://pharmacy.de/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
